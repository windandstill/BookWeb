...
<div class="divBody">
    <div class="divContent">
        ...
        4. 如果end>pageCount, 让begin=pageCount-5, end=pageCount
         --%>
        <c:choose>
            ...
            <c:otherwise>
                <c:set var="begin" value="${pb.pageNow-2 }"/>
                <c:set var="end" value="${pb.pageNow + 3}"/>
                <c:if test="${begin < 1 }">
                    <c:set var="begin" value="1"/>
        ...
        <%-- 计算begin和end --%>
        <%-- 如果总页数<=6，那么显示所有页码，即begin=1 end=${pb.pageCount} --%>
